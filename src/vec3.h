...
inline double dot(const vec3 &v, const vec3 &v2) {
    return v.e[0] * v2.e[0] + v.e[1] * v2.e[1] + v.e[2] * v2.e[2];
}

inline vec3 cross(const vec3&v, const vec3&v2) {
    return vec3(v.e[1] * v2.e[2] - v2.e[1] * v.e[2],
        v2.e[0] * v.e[2] - v.e[0] * v2.e[2],
        v.e[0] * v2.e[1] - v2.e[0] * v.e[1]);
}
